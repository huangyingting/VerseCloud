...
const curatedPoems: Poem[] = [
  ...
  },
  {
    ...
    longitude: 108.94, latitude: 34.34, placeId: 'han-changan-yuefu', placeName: '汉长安 · 乐府机构',
    relation: 'associated', confidence: 'low',
  ...
  },
  {
    ...
    longitude: 119.68, latitude: 30.63, placeId: 'anji-guzhang', placeName: '故鄣 · 安吉',
    relation: 'associated', confidence: 'low',
    evidence: '《山中杂诗》没有可识别的山名或居所；以吴均籍贯吴兴故鄣、今安吉作人物关联地，不把故里说成诗中山居。',
    sourceLabel: '南朝诗 · 开放古籍校订', sourceUrl,
  ...
  },
  {
    ...
    longitude: 118.78, latitude: 32.06, placeId: 'jiankang-envoy', placeName: '建康 · 南陈使馆',
    relation: 'composed_at', confidence: 'medium',
  ...
  },
  {
    ...
    longitude: 108.94, latitude: 34.34, placeId: 'sui-daxing-yuefu', placeName: '大兴城 · 乐府机构',
    relation: 'associated', confidence: 'low',
  ...
  },
  {
    ...
    longitude: 119.42, latitude: 32.39, placeId: 'jiangdu-palace', placeName: '江都宫 · 扬州',
