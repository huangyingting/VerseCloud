...
- 朱雀仿宋自托管网页字体，以及直接悬于诗词地点上方、从右向左的古籍式竖排全文。
- 可旋转、缩放的地图漫游，以及从全域山河自然落向诗词节点的聚焦镜头。
- 地图默认并始终保持 45° 俯角；初始范围按唐域轮廓在当前屏幕中的实际投影动态计算，横屏和竖屏都完整包住疆域。
...
- 初始包络缩放同时作为最小缩放级别，无法继续缩小到世界范围；窗口尺寸变化时会重新计算全屏包络。
